...
For uniform $I(r) = 1$,
\[
\lambda (R, p, b) = \left\{ \begin{array}{ll} 0 & R+p<b \\ R^2 \kappa_R + p^2 \kappa_p - \frac{1}{2} \sqrt{(R+p+b)(R-p+b)(-R+p+b)(R+p-b)}    & |R-p| < b \leq R+p \\ \pi p^2 & b \leq R-a \\ \pi R^2 & b \leq a-R \end{array} \right.
\]
with $\kappa_R = \mathrm{cos}^{-1}((-p^2+b^2+R^2)/2 \, b)$ and $\kappa_p = \mathrm{cos}^{-1}((p^2+b^2-R^2)/2\, p \, b)$. The derivation for this formula can be found in the appendix.
