...
problems.
Even in the absence of pipeline issues, intrinsic stellar variability
will also in general introduce statistical correlations in the
residuals over finite time intervals.
...
Processes, it ought to be possible to extend \bart\ top perform rapid
transit modeling in the presence of (at least weak) variability.
